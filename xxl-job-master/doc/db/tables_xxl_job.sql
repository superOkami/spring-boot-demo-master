...
comment on column XXL_JOB_INFO.trigger_next_time
  is '下次调度时间';
-- Create/Recreate indexes 
create index IDX_XXL_JOB_INFOXXL_JOB_INFO_AUTHOR on XXL_JOB_INFO (AUTHOR)
  tablespace USERS
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IDX_XXL_JOB_INFOXXL_JOB_INFO_EXECUTOR_HANDLER on XXL_JOB_INFO (EXECUTOR_HANDLER)
  tablespace USERS
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IDX_XXL_JOB_INFOXXL_JOB_INFO_JOB_GROUP on XXL_JOB_INFO (JOB_GROUP)
  tablespace USERS
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IDX_XXL_JOB_INFOXXL_JOB_INFO_TRIGGER_STATUS on XXL_JOB_INFO (TRIGGER_STATUS)
  tablespace USERS
  pctfree 10
  initrans 2
  maxtrans 255
